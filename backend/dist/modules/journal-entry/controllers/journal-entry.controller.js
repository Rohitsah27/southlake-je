...
let JournalEntryController = class JournalEntryController {
    ...
    async getGLJournalEntries(id, stateCode) {
...
__decorate([
    (0, common_1.Get)(':id/gl-journal-entries/:stateCode'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('stateCode')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, String]),
    __metadata("design:returntype", Promise)
], JournalEntryController.prototype, "getGLJournalEntries", null);
exports.JournalEntryController = JournalEntryController = __decorate([
